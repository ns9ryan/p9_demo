...
import (
	...
	operatorgameallocationserver "oa.98ent.com/p9/platform-game/rpc/internal/server/operatorgameallocationservice"
	operatorgamecategoryserver "oa.98ent.com/p9/platform-game/rpc/internal/server/operatorgamecategoryservice"
	operatorgamechannelserver "oa.98ent.com/p9/platform-game/rpc/internal/server/operatorgamechannelservice"
	operatorgameproviderserver "oa.98ent.com/p9/platform-game/rpc/internal/server/operatorgameproviderservice"
	operatorgameserver "oa.98ent.com/p9/platform-game/rpc/internal/server/operatorgameservice"
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		...
		platform_game_pb.RegisterOperatorGameAllocationServiceServer(grpcServer, operatorgameallocationserver.NewOperatorGameAllocationServiceServer(ctx))
		platform_game_pb.RegisterOperatorGameServiceServer(grpcServer, operatorgameserver.NewOperatorGameServiceServer(ctx))
		platform_game_pb.RegisterOperatorGameCategoryServiceServer(grpcServer, operatorgamecategoryserver.NewOperatorGameCategoryServiceServer(ctx))
		platform_game_pb.RegisterOperatorGameChannelServiceServer(grpcServer, operatorgamechannelserver.NewOperatorGameChannelServiceServer(ctx))
		platform_game_pb.RegisterOperatorGameProviderServiceServer(grpcServer, operatorgameproviderserver.NewOperatorGameProviderServiceServer(ctx))
