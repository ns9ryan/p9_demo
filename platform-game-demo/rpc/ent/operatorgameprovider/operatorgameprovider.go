...
const (
	// Label holds the string label denoting the operatorgameprovider type in the database.
	Label = "operator_game_provider"
	...
	// Table holds the table name of the operatorgameprovider in the database.
	Table = "operator_game_provider"
)

// Columns holds all SQL columns for operatorgameprovider fields.
var Columns = []string{
	FieldID,
	FieldOpCode,
	FieldProviderCode,
...
// OrderOption defines the ordering options for the OperatorGameProvider queries.
