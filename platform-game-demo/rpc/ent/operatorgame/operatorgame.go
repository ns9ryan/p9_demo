...
const (
	// Label holds the string label denoting the operatorgame type in the database.
	Label = "operator_game"
	...
	// Table holds the table name of the operatorgame in the database.
	Table = "operator_game"
)

// Columns holds all SQL columns for operatorgame fields.
var Columns = []string{
	FieldID,
	FieldOpCode,
	FieldGameCode,
...
// OrderOption defines the ordering options for the OperatorGame queries.
