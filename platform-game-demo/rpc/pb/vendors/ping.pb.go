...
const file_ping_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"ping.proto\x12\avendors\"\r\n" +
	"\vPingRequest\"(\n" +
	"\fPingResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2B\n" +
	"\vPingService\x123\n" +
	"\x04Ping\x12\x14.vendors.PingRequest\x1a\x15.vendors.PingResponseB.Z,oa.98ent.com/p9/platform-game/rpc/pb/vendorsb\x06proto3"
...
var file_ping_proto_goTypes = []any{
	(*PingRequest)(nil),  // 0: vendors.PingRequest
	(*PingResponse)(nil), // 1: vendors.PingResponse
}
var file_ping_proto_depIdxs = []int32{
	0, // 0: vendors.PingService.Ping:input_type -> vendors.PingRequest
	1, // 1: vendors.PingService.Ping:output_type -> vendors.PingResponse
