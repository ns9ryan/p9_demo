module oa.98ent.com/p9/platform-game
...
require (
	...
	oa.98ent.com/p9/core v0.0.0-00010101000000-000000000000
)
...
replace (
	...
	oa.98ent.com/p9/platform-game/rpc/pb/vendors => ./rpc/pb/vendors
)
