...
func (_u *APIUpdate) SetIsRequired(v int16) *APIUpdate {
	_u.mutation.ResetIsRequired()
	_u.mutation.SetIsRequired(v)
	return _u
}

// SetNillableIsRequired sets the "is_required" field if the given value is not nil.
func (_u *APIUpdate) SetNillableIsRequired(v *int16) *APIUpdate {
	if v != nil {
		_u.SetIsRequired(*v)
	}
	return _u
...
// AddIsRequired adds value to the "is_required" field.
func (_u *APIUpdate) AddIsRequired(v int16) *APIUpdate {
	_u.mutation.AddIsRequired(v)
	return _u
}
...
func (_u *APIUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.IsRequired(); ok {
		_spec.SetField(api.FieldIsRequired, field.TypeInt16, value)
	}
	if value, ok := _u.mutation.AddedIsRequired(); ok {
		_spec.AddField(api.FieldIsRequired, field.TypeInt16, value)
	}
...
// SetIsRequired sets the "is_required" field.
func (_u *APIUpdateOne) SetIsRequired(v int16) *APIUpdateOne {
	_u.mutation.ResetIsRequired()
	_u.mutation.SetIsRequired(v)
	return _u
}
...
// SetNillableIsRequired sets the "is_required" field if the given value is not nil.
func (_u *APIUpdateOne) SetNillableIsRequired(v *int16) *APIUpdateOne {
	if v != nil {
		_u.SetIsRequired(*v)
	}
	return _u
...
// AddIsRequired adds value to the "is_required" field.
func (_u *APIUpdateOne) AddIsRequired(v int16) *APIUpdateOne {
	_u.mutation.AddIsRequired(v)
	return _u
}
