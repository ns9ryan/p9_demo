...
func (_c *RoleCreate) SetStatus(v int16) *RoleCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *RoleCreate) SetNillableStatus(v *int16) *RoleCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *RoleCreate) SetSortNo(v int) *RoleCreate {
	_c.mutation.SetSortNo(v)
	return _c
}

// SetNillableSortNo sets the "sort_no" field if the given value is not nil.
func (_c *RoleCreate) SetNillableSortNo(v *int) *RoleCreate {
	if v != nil {
		_c.SetSortNo(*v)
	}
	return _c
...
func (_c *RoleCreate) check() error {
	...
	if _, ok := _c.mutation.SortNo(); !ok {
		return &ValidationError{Name: "sort_no", err: errors.New(`ent: missing required field "Role.sort_no"`)}
	}
	return nil
}
