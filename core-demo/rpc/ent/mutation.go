...
// SysInitMutation represents an operation that mutates the SysInit nodes in the graph.
type SysInitMutation struct {
	config
	op            Op
	typ           string
	id            *int64
	...
	oldValue      func(context.Context) (*SysInit, error)
	predicates    []predicate.SysInit
}

var _ ent.Mutation = (*SysInitMutation)(nil)

// sysinitOption allows management of the mutation configuration using functional options.
type sysinitOption func(*SysInitMutation)

// newSysInitMutation creates new mutation for the SysInit entity.
func newSysInitMutation(c config, op Op, opts ...sysinitOption) *SysInitMutation {
	m := &SysInitMutation{
		config:        c,
		op:            op,
		typ:           TypeSysInit,
...
// withSysInitID sets the ID field of the mutation.
func withSysInitID(id int64) sysinitOption {
	return func(m *SysInitMutation) {
		var (
			err   error
			once  sync.Once
			value *SysInit
		)
		m.oldValue = func(ctx context.Context) (*SysInit, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().SysInit.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withSysInit sets the old SysInit of the mutation.
func withSysInit(node *SysInit) sysinitOption {
	return func(m *SysInitMutation) {
		m.oldValue = func(context.Context) (*SysInit, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m SysInitMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m SysInitMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of SysInit entities.
func (m *SysInitMutation) SetID(id int64) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SysInitMutation) ID() (id int64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SysInitMutation) IDs(ctx context.Context) ([]int64, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().SysInit.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *SysInitMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *SysInitMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the SysInit entity.
// If the SysInit object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SysInitMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *SysInitMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *SysInitMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *SysInitMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the SysInit entity.
// If the SysInit object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SysInitMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *SysInitMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetInitKey sets the "init_key" field.
func (m *SysInitMutation) SetInitKey(s string) {
	m.init_key = &s
}

// InitKey returns the value of the "init_key" field in the mutation.
func (m *SysInitMutation) InitKey() (r string, exists bool) {
	v := m.init_key
	if v == nil {
		return
	}
...
// OldInitKey returns the old "init_key" field's value of the SysInit entity.
// If the SysInit object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SysInitMutation) OldInitKey(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldInitKey is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldInitKey requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldInitKey: %w", err)
	}
	return oldValue.InitKey, nil
}

// ResetInitKey resets all changes to the "init_key" field.
func (m *SysInitMutation) ResetInitKey() {
	m.init_key = nil
}

// Where appends a list predicates to the SysInitMutation builder.
func (m *SysInitMutation) Where(ps ...predicate.SysInit) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the SysInitMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SysInitMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.SysInit, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *SysInitMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *SysInitMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (SysInit).
func (m *SysInitMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *SysInitMutation) Fields() []string {
	fields := make([]string, 0, 3)
	if m.created_at != nil {
		fields = append(fields, sysinit.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, sysinit.FieldUpdatedAt)
	}
	if m.init_key != nil {
		fields = append(fields, sysinit.FieldInitKey)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *SysInitMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *SysInitMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case sysinit.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case sysinit.FieldUpdatedAt:
		return m.OldUpdatedAt(ctx)
	case sysinit.FieldInitKey:
		return m.OldInitKey(ctx)
	}
	return nil, fmt.Errorf("unknown SysInit field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SysInitMutation) SetField(name string, value ent.Value) error {
	switch name {
	case sysinit.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
	...
	return fmt.Errorf("unknown SysInit field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *SysInitMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *SysInitMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SysInitMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown SysInit numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *SysInitMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *SysInitMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *SysInitMutation) ClearField(name string) error {
	return fmt.Errorf("unknown SysInit nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *SysInitMutation) ResetField(name string) error {
	switch name {
	case sysinit.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *SysInitMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *SysInitMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *SysInitMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *SysInitMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *SysInitMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *SysInitMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *SysInitMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown SysInit unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *SysInitMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown SysInit edge %s", name)
}
