...
func IsRequired(v int16) predicate.API {
...
func IsRequiredEQ(v int16) predicate.API {
	return predicate.API(sql.FieldEQ(FieldIsRequired, v))
}

// IsRequiredNEQ applies the NEQ predicate on the "is_required" field.
func IsRequiredNEQ(v int16) predicate.API {
	return predicate.API(sql.FieldNEQ(FieldIsRequired, v))
}

// IsRequiredIn applies the In predicate on the "is_required" field.
func IsRequiredIn(vs ...int16) predicate.API {
	return predicate.API(sql.FieldIn(FieldIsRequired, vs...))
}

// IsRequiredNotIn applies the NotIn predicate on the "is_required" field.
func IsRequiredNotIn(vs ...int16) predicate.API {
	return predicate.API(sql.FieldNotIn(FieldIsRequired, vs...))
}

// IsRequiredGT applies the GT predicate on the "is_required" field.
func IsRequiredGT(v int16) predicate.API {
	return predicate.API(sql.FieldGT(FieldIsRequired, v))
}

// IsRequiredGTE applies the GTE predicate on the "is_required" field.
func IsRequiredGTE(v int16) predicate.API {
	return predicate.API(sql.FieldGTE(FieldIsRequired, v))
}

// IsRequiredLT applies the LT predicate on the "is_required" field.
func IsRequiredLT(v int16) predicate.API {
	return predicate.API(sql.FieldLT(FieldIsRequired, v))
}

// IsRequiredLTE applies the LTE predicate on the "is_required" field.
func IsRequiredLTE(v int16) predicate.API {
	return predicate.API(sql.FieldLTE(FieldIsRequired, v))
}
