...
func (*API) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case api.FieldID, api.FieldIsRequired:
			values[i] = new(sql.NullInt64)
		case api.FieldDescription, api.FieldAPIGroup, api.FieldMethod, api.FieldPath, api.FieldServiceName:
	...
	for i := range columns {
		...
		case api.FieldIsRequired:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.IsRequired = int16(value.Int64)
			}
