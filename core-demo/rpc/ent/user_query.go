...
type UserQuery struct {
	...
	withActionLogs *AdminActionLogQuery
	withErrorLogs  *ErrorLogQuery
...
func (_q *UserQuery) QueryLoginLogs() *LoginLogQuery {
	query := (&LoginLogClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) QueryActionLogs() *AdminActionLogQuery {
...
// QueryErrorLogs chains the current query on the "error_logs" edge.
func (_q *UserQuery) QueryErrorLogs() *ErrorLogQuery {
	query := (&ErrorLogClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withLoginLogs:  _q.withLoginLogs.Clone(),
		withActionLogs: _q.withActionLogs.Clone(),
		withErrorLogs:  _q.withErrorLogs.Clone(),
...
func (_q *UserQuery) WithLoginLogs(opts ...func(*LoginLogQuery)) *UserQuery {
	query := (&LoginLogClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withLoginLogs = query
	return _q
}
...
func (_q *UserQuery) WithActionLogs(opts ...func(*AdminActionLogQuery)) *UserQuery {
	query := (&AdminActionLogClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withActionLogs = query
	return _q
}

// WithErrorLogs tells the query-builder to eager-load the nodes that are connected to
// the "error_logs" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithErrorLogs(opts ...func(*ErrorLogQuery)) *UserQuery {
	query := (&ErrorLogClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withErrorLogs = query
	return _q
}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	var (
		...
		loadedTypes = [4]bool{
			_q.withRoles != nil,
			_q.withLoginLogs != nil,
			_q.withActionLogs != nil,
			_q.withErrorLogs != nil,
		}
	)
	...
	if query := _q.withLoginLogs; query != nil {
		if err := _q.loadLoginLogs(ctx, query, nodes,
			func(n *User) { n.Edges.LoginLogs = []*LoginLog{} },
			func(n *User, e *LoginLog) { n.Edges.LoginLogs = append(n.Edges.LoginLogs, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withActionLogs; query != nil {
		if err := _q.loadActionLogs(ctx, query, nodes,
			func(n *User) { n.Edges.ActionLogs = []*AdminActionLog{} },
			func(n *User, e *AdminActionLog) { n.Edges.ActionLogs = append(n.Edges.ActionLogs, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withErrorLogs; query != nil {
		if err := _q.loadErrorLogs(ctx, query, nodes,
			func(n *User) { n.Edges.ErrorLogs = []*ErrorLog{} },
			func(n *User, e *ErrorLog) { n.Edges.ErrorLogs = append(n.Edges.ErrorLogs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadLoginLogs(ctx context.Context, query *LoginLogQuery, nodes []*User, init func(*User), assign func(*User, *LoginLog)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(loginlog.FieldUserID)
	}
	query.Where(predicate.LoginLog(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.LoginLogsColumn), fks...))
	}))
...
func (_q *UserQuery) loadActionLogs(ctx context.Context, query *AdminActionLogQuery, nodes []*User, init func(*User), assign func(*User, *AdminActionLog)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(adminactionlog.FieldUserID)
	}
	query.Where(predicate.AdminActionLog(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.ActionLogsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadErrorLogs(ctx context.Context, query *ErrorLogQuery, nodes []*User, init func(*User), assign func(*User, *ErrorLog)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(errorlog.FieldUserID)
	}
	query.Where(predicate.ErrorLog(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.ErrorLogsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
