...
const (
	// Label holds the string label denoting the operatorlanguage type in the database.
	Label = "operator_language"
	...
	// Table holds the table name of the operatorlanguage in the database.
	Table = "operator_language"
	// OperatorTable is the table that holds the operator relation/edge.
	OperatorTable = "operator_language"
...
// Columns holds all SQL columns for operatorlanguage fields.
var Columns = []string{
	FieldID,
	FieldOperatorID,
	FieldLanguageCode,
...
// OrderOption defines the ordering options for the OperatorLanguage queries.
