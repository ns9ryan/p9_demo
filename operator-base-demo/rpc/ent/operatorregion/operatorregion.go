...
const (
	// Label holds the string label denoting the operatorregion type in the database.
	Label = "operator_region"
	...
	// Table holds the table name of the operatorregion in the database.
	Table = "operator_region"
	// OperatorTable is the table that holds the operator relation/edge.
	OperatorTable = "operator_region"
...
// Columns holds all SQL columns for operatorregion fields.
var Columns = []string{
	FieldID,
	FieldOperatorID,
	FieldRegionCode,
...
// OrderOption defines the ordering options for the OperatorRegion queries.
