...
const (
	// Label holds the string label denoting the operatoragentline type in the database.
	Label = "operator_agent_line"
	...
	// Table holds the table name of the operatoragentline in the database.
	Table = "operator_agent_line"
	// OperatorTable is the table that holds the operator relation/edge.
	OperatorTable = "operator_agent_line"
...
// Columns holds all SQL columns for operatoragentline fields.
var Columns = []string{
	FieldID,
	FieldOperatorID,
	FieldAgentLineCode,
...
// OrderOption defines the ordering options for the OperatorAgentLine queries.
