...
// 分配经营地区
func (l *AssignLogic) Assign(in *regionallocation.AssignRegionRequest) (*regionallocation.AssignRegionResponse, error) {
	// todo: add your logic here and delete this line

	return &regionallocation.AssignRegionResponse{}, nil
}
