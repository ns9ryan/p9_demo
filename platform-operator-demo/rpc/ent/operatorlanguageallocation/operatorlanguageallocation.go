...
const (
	// Label holds the string label denoting the operatorlanguageallocation type in the database.
	Label = "operator_language_allocation"
	...
	// Table holds the table name of the operatorlanguageallocation in the database.
	Table = "operator_language_allocation"
	// OperatorTable is the table that holds the operator relation/edge.
	OperatorTable = "operator_language_allocation"
...
// Columns holds all SQL columns for operatorlanguageallocation fields.
var Columns = []string{
	FieldID,
...
// OrderOption defines the ordering options for the OperatorLanguageAllocation queries.
