...
// GetByCode 按编码获取货币
func (l *GetByCodeLogic) GetByCode(in *currencypb.GetCurrencyByCodeRequest) (*currencypb.GetCurrencyByCodeResponse, error) {
	// 整理货币编码
	...
	// 返回货币信息
	return &currencypb.GetCurrencyByCodeResponse{
