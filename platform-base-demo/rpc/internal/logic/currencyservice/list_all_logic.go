...
// ListAll 获取全部货币
func (l *ListAllLogic) ListAll(in *currencypb.ListAllCurrenciesRequest) (*currencypb.ListAllCurrenciesResponse, error) {
	// 校验状态
	...
	// 返回货币列表
	return &currencypb.ListAllCurrenciesResponse{
		List: list, // 货币列表
	}, nil
}
